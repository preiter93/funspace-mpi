...
pub extern crate mpi_custom as mpi;
pub mod distribute;
pub mod functions;
...
impl<'a> Decomp2d<'a> {
    ...
    /// Scatter data from root to all processors, distributed as x-pencil
    ...
    /// Scatter data from root to all processors, distributed as y-pencil
