//! Chebyshev base with Neumann boundary conditions
...
#[derive(Clone)]
pub struct StencilChebNeumann<A> {
...
impl<A: FloatNum> StencilChebNeumann<A> {
...
impl<A: FloatNum> Stencil<A> for StencilChebNeumann<A> {
